...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.0, 49.0, 150.0, 64.0 ],
					"text" : "this is apotential approach to find periods in the signal, but only outside spectral analysis for now"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 283.0, 152.0, 136.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 283.0, 201.0, 44.0, 44.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@module", 0, "@loop", 1, "@file", "cherokee.aif", "@vol", 0 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ -4.0, -3.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 27.0, 41.0, 219.0, 89.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 435.0, 44.0, 44.0 ],
					"prototypename" : "helpfile"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 149.0, 278.5, 90.0, 23.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 89.0, 278.5, 56.0, 23.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, -14.0, 505.0, 50.0 ],
					"text" : "Segmenting waveforms by zero crossings - also pitchshifter (playbackspeed)"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 36.5, 139.5, 292.5, 139.5 ],
					"order" : 0,
					"source" : [ "obj-2", 0 ]
				}
